  ...
  const projects: Project[] = [
    {
      ...
      description:
        "Revolutionary AI-powered platform that transforms business operations through intelligent automation, reducing manual tasks by 75% and boosting productivity.",
    ...
    },
    {
      ...
      category: "Healthcare",
      technologies: ["Vue.js", "Laravel", "MySQL", "Docker", "Redis", "WebRTC"],
      image:
            ...
            >
              {filteredProjects.map((project, index) => (
                ...
                >
                  ...
                  {/* Content Section - HeroUI Card Body */}
                  <div
